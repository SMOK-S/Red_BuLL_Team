...
- Done Installations Source SMOK 
 - Thanks For your use Source SMOK
 ══════════════════════════════    
...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1753984669,1753984669}
print("\27[34m"..[[
...
if hash or DevSMOK(msg) or DevBot(msg) then 
return true 
else 
return false 
end 
...
if hash or DevSMOK(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevSMOK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevSMOK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevSMOK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "SMOKTEAM")
for SMOK in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = SMOK
end
...
local SMOK_Msg = database:get(bot_id.."SMOK:Add:Filter:Rp2"..text..msg.chat_id_)   
if SMOK_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","⌁︙ "..SMOK_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
local list = database:smembers(bot_id.."SMOK:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SMOK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SMOK:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SMOK:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⌁︙ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local SMOK_Msg = database:get(bot_id.."SMOK:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ›› {"..SMOK_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."SMOK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SMOK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SMOK:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."SMOK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SMOK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SMOK:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SMOK:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."SMOK:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SMOK:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SMOK:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local UserName = (b.username_ or "SMOKTEAM")
...
setex:set(bot_id.."SMOK:Set:klesh:id"..msg.chat_id_,Text_Rand)
...
if text == 'السيرفر' and DevSMOK(msg) then 
...
ge = https.request('https://ahmedcg4.ml/Age.php?SMOK='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.Age.YouAge)
end
if text and text:match("^معنى (.*)$") and database:get(bot_id.."SMOK:nam_Bots"..msg.chat_id_) == "open" then
...
if text and text:match("^برج (.*)$") and database:get(bot_id.."SMOK:abr_Bots"..msg.chat_id_) == "open" then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SMOKTele/files_SMOK/master/files_SMOK/"..file)
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SMOK-S/files_SMOK/master/files_SMOK/"..file)
if res == 200 then
...
𓂅 *. SMOK TeAM *
*••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••*
𓂅 . [Source Channel .](https://t.me/X6YX6)

𓂅 . [Files Channel .](https://t.me/X6YX6)

𓂅 . [The Developer .](https://t.me/E444Q)

𓂅 . [The programmer .](https://t.me/E444Q)
*••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••*
𓂅 . [Bot TwsL Dev .](https://t.me/E444Q)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
if not DevSMOK(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if text and text:match("^تغير رساله الاشتراك ✉️$") and DevSMOK(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⌁︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رسالة الاشتراك ⌨️" and DevSMOK(msg) then  
...
if text == "تفعيل الاشتراك 🔭" and DevSMOK(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك 📠" and DevSMOK(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⌁︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 🗳️" and DevSMOK(msg) then  
...
if text == ("المطورين 🛡️") and DevSMOK(msg) then
local list = database:smembers(bot_id.."SMOK:Sudo:User")
t = "\n⌁︙ قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."SMOK:User:Name" .. v)
...
------------------------------------------------------------------------
if text then
local SMOK_Msg = database:get(bot_id.."SMOK:Add:Filter:Rp2"..text..result.chat_id_)   
if SMOK_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","⌁︙ "..SMOK_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
